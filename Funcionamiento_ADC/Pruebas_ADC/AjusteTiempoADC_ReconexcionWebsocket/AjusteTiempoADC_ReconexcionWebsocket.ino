...
<head>
  ...
  <script>
    ...
    var recordedData = [];
    var ws;
    var slider1Value = 250;
    var slider2Value = 100;
    ...
    function wsConnect() {
        ...
        ws.onmessage = function(event) {
            ...
            if (data.slider1 !== undefined && data.slider2 !== undefined) {
                ...
                updateFrequencyDisplay(data.slider1, data.slider2);
            } else {
    ...
    function updateFrequencyDisplay(freq1, freq2) {
        document.getElementById("currentFreq1").textContent = freq1 + " Hz";
        document.getElementById("currentFreq2").textContent = freq2 + " Hz";
    }
  </script>
</head>
<body>
  ...
  <div id='chart1Container' class='hidden'><canvas id='adcChart1'></canvas>
    ...
    <p>Frecuencia Actual: <span id="currentFreq1">250</span> Hz</p>
  ...
  <div id='chart2Container' class='hidden'><canvas id='adcChart2'></canvas>
    ...
    <p>Frecuencia Actual: <span id="currentFreq2">100</span> Hz</p>
